...
export const recognition = [
  ...
  { kind: 'cert',    issuer: 'Microsoft Azure', name: 'Azure AI Engineer Associate',           note: 'AI-102',    link: './certs/ai102.pdf' },
  { kind: 'cert',    issuer: 'Microsoft Azure', name: 'Azure Data Scientist Associate',        note: 'DP-100',    link: './certs/dp100.pdf' },
  { kind: 'cert',    issuer: 'Microsoft Azure', name: 'Azure Fundamentals',                    note: 'AZ-900',    link: './certs/az900.pdf' },
  { kind: 'cert',    issuer: 'Google Cloud',    name: 'Cloud Digital Leader',                  note: '',           link: 'https://cloud.google.com/learn/certification/cloud-digital-leader' },
